...
| Issue target | the credential-free canonical URL naming the container new issues are created in, together with an optional explicit provider discriminator. It is replaceable composition data supplied by lexical context; it requests a destination and grants nothing |
