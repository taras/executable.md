...
nothing at a later site — and because the name is not what is checked, it
authorizes nothing under an alias, inside a copy of the definition, or after the
invocation that produced it is over either. What is restricted is the
implementation the closure built; a definition a handler wrote carries a
different function and stays the open import it always was. And a private name written where no offer was made
