...
and divergence. A proven ancestor is a performable pre-state, published over by
the same exact non-force refspec a proven absence gets; an equal destination is
adopted with nothing performed; and compatibility that was not proved — a
divergent commit, or one the source does not hold — is a conflict. Nothing is
