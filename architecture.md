...
own, and two contributions that *disagree* about one component of one package —
the same component from two different assets — refuse at collection. Collection
...
is documented exactly once and the layering is not a failure.
