import { a as AcpPermissionRequest, c as NonInteractivePermissionPolicy, f as SessionRecord, i as AcpPermissionDecision, l as PermissionMode, n as SystemPromptOption, s as McpServer$1, t as SessionAgentOptions } from "./session-options-jkYbBxGE.d.ts";
import { a as RequestedModelUnsupportedErrorCode, i as RequestedModelUnsupportedError, n as REQUESTED_MODEL_UNSUPPORTED_ERROR_CODE, o as RequestedModelUnsupportedReason, r as REQUESTED_MODEL_UNSUPPORTED_REASONS, s as isRequestedModelUnsupportedError, t as AcpClient } from "./client-DwNyFauq.d.ts";
...
type AcpRuntimeOptions = {
  ...
  verbose?: boolean;
  /**
   * Environment merged last into every agent child this runtime spawns —
   * doctor, ensure, reconnect, control and turn clients alike.
   *
   * Transient by construction: it is never copied into `SessionAgentOptions`,
   * a session record, an event, a status, a diagnostic, or a serialized store,
   * and it never touches the parent process environment. Local patch; see
   * vendor/acpx/PROVENANCE.md.
   */
