...
var AcpRuntimeManager = class {
	...
	createClient(options) {
		const withEnv = this.options.agentProcessEnv === undefined ? options : {
			...options,
			agentProcessEnv: this.options.agentProcessEnv
		};
		return this.deps.clientFactory?.(withEnv) ?? new AcpClient(withEnv);
	}
...
function createProbeClient(options, agentCommand, deps) {
	const clientOptions = {
		...
		...(options.agentProcessEnv === undefined ? {} : { agentProcessEnv: options.agentProcessEnv })
	};
