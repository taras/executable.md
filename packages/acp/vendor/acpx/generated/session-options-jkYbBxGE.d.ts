...
type AcpClientOptions = {
  ...
  /**
   * Environment merged last into this client's agent child. Transient: never
   * persisted to a session record and never applied to this process. Local
   * patch; see vendor/acpx/PROVENANCE.md.
   */
