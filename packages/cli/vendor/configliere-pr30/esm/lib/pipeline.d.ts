import type { AddField, AddParamToLast, AddRoutesToLast, AnyPhase, AnyPhases, AnyRoute, ChildrenOf, Done, Method, MethodsOf, ModelOf, Next, Phase, Route } from "./types.js";
