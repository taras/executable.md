 ...
 * installs a resolver for one name in the current scope, delegating every
 * other name outward. Nested registrations override an outer registration
...
/** Make `factory` resolvable as `name` for the current scope. */
