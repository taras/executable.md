 ...
 * expansion nested.
 *
 * Everything here claims a name, because the boundary is the subject. The same
 * contract inside the engine's own constructs is
 * `construct-error-observation.test.ts`, which installs no extension at all.
 */
