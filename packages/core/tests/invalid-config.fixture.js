 ...
 * that installs a Config middleware with a value that is not a number — the
 * case ConfigApi's TypeScript type forbids, but which the runtime validation
 * must still reject. Deliberately untyped so the invalid value reaches the
