...
import { WorkflowStorageError } from "@executablemd/workflow";
import { createWorkflowWorkspaceEffect } from "@executablemd/workflow/deno";
import { isJournalableWorkspaceFailure } from "@executablemd/workflow/deno";
import type { WorkflowWorkspaceFilesystem } from "@executablemd/workflow/deno";
...
export interface MutationContext {
  readonly filesystem: WorkflowWorkspaceFilesystem;
