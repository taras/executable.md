...
import type { DenoWorkspaceFilesystem } from "../../workflow/src/deno/workspace/filesystem.ts";
import { throwWorkspaceFilesystemFailure } from "../../workflow/src/deno/workspace/errors.ts";
import {
  createRun,
  runPath,
  useStorageRoot,
...
function runForged(
  ...
  return scoped(function* () {
    ...
    return yield* withWorkflowWorkspace(
      ...
      { attachments: [gitWorkspaceAttachment(options)] },
    );
  });
}
