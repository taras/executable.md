/**
 * Tier TX — the tmux grid provider
 * (architecture.md §Interactive grids, issue #732).
 *
...
import { nativeLaunch, reserveTerminal, Grids } from "@executablemd/grid";
import type { GridComposite } from "@executablemd/grid";
import { installControlledLauncher } from "@executablemd/grid/test";
import { tmpdir } from "node:os";
import { randomUUID } from "node:crypto";
import { processReachable, TerminalProcesses } from "@executablemd/grid/processes";
import type { SignalDelivery } from "@executablemd/grid/processes";
