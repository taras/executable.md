...
const EMBEDDED_TESTS = [
  ...
  "No resource exists before a standalone Thing",
  "A standalone Thing's resource does not outlive it",
  "No resource exists before a paired Thing",
  "A paired Thing releases its resource when it finishes",
  "A paired Thing's resource is live while its content expands",
