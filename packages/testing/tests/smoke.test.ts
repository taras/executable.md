...
const EMBEDDED_TESTS = [
  ...
  "A component with content wraps what it is given",
  "An empty pair of tags is still the wrapping form",
  "A self-closing component allocates instead of wrapping",
  "A retained resource is still alive for a later sibling",
