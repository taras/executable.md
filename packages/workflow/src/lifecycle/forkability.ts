 ...
 * the fork cannot enter, a Git-host effect that already happened on somebody
 * else's server, and a retained effect this build has never heard of are all
 * events a fork would have to pretend it understood.
 *
