...
const MEMBERS = ["core", "runtime", "durable-streams", "terminal", "acp"] as const;
  ...
  it("SYN47: publishes the documentation assets and renders them for a consumer", function* () {
    ...
    yield* writeTextFile(
      ...
      [
        ...
        "// component from each of the two documentation assets. One call brings",
        "// the Agent registrations and the documentation that describes them,",
        "// which is the whole point of the bootstrap being one thing.",
        'import { collect, useAgentComponents } from "@executablemd/core";',
        ...
        "          includes: [],",
        "        },",
        "        // Nothing to install: the bootstrap above already put both the",
        "        // registrations and their documentation in this scope.",
        "        [],",
        "      ),",
        "    );",
        "  });",
