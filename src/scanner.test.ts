...
describe("scanSegments", () => {
  ...
  it("A2: block component with text children", () => {
  ...
  it("A4: string attribute containing >", () => {
  ...
  it("A5: expression attribute with nested braces", () => {
  ...
  it("A6: template literal attribute", () => {
  ...
  it("A8: not a component — comparison expression", () => {
  ...
  it("A9: incomplete tag at end of input", () => {
  ...
  it("A10: code block with exec modifier", () => {
  ...
  it("A11: code block with silent exec", () => {
  ...
  it("A12: code block without exec is text", () => {
  ...
  it("A13: code block with modifiers but no exec", () => {
  ...
  it("A14: component inside fenced code block is text", () => {
  ...
  it("A16: numeric expression prop", () => {
  ...
  it("mixed content: text + component + code block", () => {
    const input = `# Hello
...
`;
  ...
  it("component with multiple string props", () => {
...
describe("parseInfoString", () => {
  ...
  it("parses language + silent + exec", () => {
  ...
  it("parses modifier with params", () => {
